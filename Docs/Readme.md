...
`enclave` _(/ankleiv/)_ -> _Uncle Abe_  .... well, not exactly a pinnacle of imagination (or wit) :). Have to ask James Albany for the name.
Anyway, a code name for the project to fully offload wrapping/unwrapping of offensive payloads with 
Intel SGX technology assist.
...
- [App/Bridge/Enclave Code](https://dev.azure.com/proseclabs/Lab%20Development/_git/UncleAbe)

- Server C&C code will be linked later
