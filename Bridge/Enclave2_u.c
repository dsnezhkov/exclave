...
sgx_status_t createRsaKeyPairEcall(sgx_enclave_id_t eid, char* public_key_raw_out, char* public_key_out)
{
	sgx_status_t status;
...
sgx_status_t storeSymKeyEcall(sgx_enclave_id_t eid, unsigned char* encrypted_payload, size_t encrypted_payload_len)
{
	sgx_status_t status;
	ms_storeSymKeyEcall_t ms;
...
sgx_status_t decryptPayloadEcall(sgx_enclave_id_t eid, unsigned char* encrypted_payload, size_t encrypted_payload_len, unsigned char* mac)
{
	sgx_status_t status;
